...
import { toggleInitiativeFavorite } from "@/server/actions/favorites";
import { cn } from "@/lib/utils";

export function InitiativeFavoriteButton({
  initiativeId,
  ...
  function handleClick(event: MouseEvent<HTMLButtonElement>) {
    ...
    startTransition(async () => {
      const result = await toggleInitiativeFavorite(initiativeId);
